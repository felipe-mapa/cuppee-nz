...
<style> 
    ...
    <body>
        <main class="container">
            ...
            <h1>Cuppee - New purchase</h1>
            <?php   
                $getAddress = $cmr->getAddress();
                $address = $getAddress->fetch_assoc();
            ?>
            <div>
                <h2 class="h2-address">Customer information:</h2>
                <p><?php echo $address['customerName']; ?></p>
                <p><?php echo $address['customerEmail']; ?></p>
                <?php if ($address['customerMobile'] != "0"){ ?>
                        <p><?php echo $address['customerMobile']; ?></p>
                <?php }?>
